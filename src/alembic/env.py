...
# setup sqlalchemy url to refer to postgresql engine connection url.
...
# replace sqlalchemy.url in alembic.ini to refer given postgres connection url.
config.set_main_option(name="sqlalchemy.url", value=url.render_as_string(hide_password=False))
